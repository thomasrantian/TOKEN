...
# Utility functions [used in making the observations]
...
class VectorObservation:
    ...
    # A 2d array representing the lanes geometry
    # Each row represents the flatted lane waypoints 32 x 32 x 4
    lane_geom_descriptors: torch.FloatTensor

    # A 2d array representing the adjacency matrix of the lanes
    lane_topo_descriptors: torch.FloatTensor

    # A 2d array describing the information of the agents
    # Each row represents the agent information: past traj hist (x,y,v) flatted, agent type id
    agents_descriptors: torch.FloatTensor

    # A 1D array describing the information of the ego agent
    # ego past traj hist (x,y,v) flatted
    ego_vehicle_descriptor: torch.FloatTensor


class VectorObservationConfig:
    num_route_points: int = 30
    num_agent_slots: int = 20
...
class BEVObservation:
    ...
    bev_descriptors: torch.FloatTensor