...
def load_model(
    ...
    if load_in_8bit:
        ...
        model = VectorLMWithLoRA(llama_model, lora_config, feature_mode=feature_mode, adapter_mode = adapter_mode, use_ego_state_info=use_ego_state_info, root_data_path=root_data_path, freeze_LORA=freeze_LORA)        
